...
export const postsList = (state = INITIAL_POSTSLIST, action) => {
  let error
  switch (action.type) {
...
export const activePost = (state = INITIAL_POST, action) => {
  let error
  switch (action.type) {
    case FETCH_POST:
      return {
...
export const newPost = (state = INITIAL_POST, action) => {
  let error
  switch (action.type) {
    case CREATE_POST:
      return {
...
export const deletePost = (state = INITIAL_POST, action) => {
  let error
  switch (action.type) {
    case DELETE_POST:
      return {
        ...state,
        deletedPost: {...state.deletedPost, loading: true}
      }
    ...
    case DELETE_POST_FAILURE:
      ...
      return {
        ...state,
        deletedPost: {post: null, error: error, loading: false}
      }
...
export const validatePost = (state = INITIAL_POST, action) => {
  let error
  switch (action.type) {
    case VALIDATE_POST_FIELDS:
      return {
        ...state,
        newPost: {...state.newPost, error: null, loading: true}
      }
    case VALIDATE_POST_FIELDS_SUCCESS:
      return {
        ...state,
        newPost: {...state.newPost, error: null, loading: false}
      }
    ...
    case VALIDATE_POST_FIELDS_FAILURE:
      ...
      return {
        ...state,
        newPost: {...state.newPost, error: error, loading: false}
      }
    case RESET_POST_FIELDS:
      return {
        ...state,
        newPost: {...state.newPost, error: null, loading: null}
      }
    default:
      return state
  }
